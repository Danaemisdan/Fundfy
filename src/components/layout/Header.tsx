  ...
  return (
    <header className="relative z-50 flex flex-row justify-between items-center px-4 md:px-8 lg:px-16 pt-6 shrink-0 w-full max-w-7xl mx-auto">
      ...
      <button 
        ...
        className="flex flex-col items-center justify-center px-6 py-3 rounded-none bg-[#11131c] text-white shadow-xl hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-0.5 transition-all duration-300 group relative overflow-hidden border border-white/10 shrink-0"
      >
